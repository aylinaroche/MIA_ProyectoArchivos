...
int copiarRaizArchivo(char* ruta, superbloque super, int posicion, char* iddest,
		char* dest);
char* contenidoArchivo(char* mensaje, int posicion, superbloque super,
		char* ruta, char* name);
void renombrar();
...
char* buscarCarpeta(char* ruta, char* path, superbloque super, int posicion,
		char* msj, int espacio);
int buscarRaizCarpeta(char* ruta, superbloque super, int posicion,
		char* mensaje, int espacio);
int buscarRaizArchivo(char* ruta, superbloque super, int posicion, char*mensaje,
		int espacio);
...
void imprimirLista();
void journaling(char *ruta, int posicion, superbloque sb, int tipoOp,
		char *path, char *contenido, char *id, int tipo);
